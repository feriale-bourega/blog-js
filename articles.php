        ...
        <h1 class="title-main">Liste des articles</h1>
            <table id="customers">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            <td><a href="article.php?id=<?= $article['id'] ?>"><?= $article['article'] ?></a></td>
                            <td><a href="article.php?id=<?= $article['id'] ?>"><?=  date_format(date_create($article['date']), 'd/m/Y H:i:s') ?></a></td>
                            <td><a href="article.php?id=<?= $article['id'] ?>"><img src="assets/images/articles/<?php echo $article['images'] ?>" alt=""></a></td>
                        </tr>
                    <?php
                    }
                    ?>
